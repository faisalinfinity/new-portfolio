...
export const projectsData: project[] = [
  {
    ...
    description:
      "A Modern Social QnA Platform for Developers with AI Answers generation similar to Stack Overflow",
    techStack: [
      { name: "Mongodb" },
      { name: "NextJS" },
      { name: "NodeJS" },
    ...
    imageUrl:
      "https://res.cloudinary.com/dq674z2lp/image/upload/v1736859024/devflow-dark_y45wos.png",
  ...
  },
  {
    ...
    imageUrl:
      "https://res.cloudinary.com/dq674z2lp/image/upload/v1680457610/18-admin-add-pc_uwpsgz.png",
  ...
  },
  {
    ...
    description:
      "Captain America - A Multiplayer Game with Realtime Global chat and scores built within 48hrs.",
    techStack: [
      { name: "Mongodb" },
      { name: "Typescript" },
      { name: "React" },
    ...
    imageUrl:
      "https://res.cloudinary.com/dq674z2lp/image/upload/v1681144295/mobile_3_ty3cgl.png",
  ...
  },
  {
    ...
    description:
      "Productify is an Ecommerce Website which serves as a platform by offering buyers and sellers a wide range of choice to buy and sell goods through listing format, item condition and delivery format.",
    techStack: [
      { name: "Redux" },
      { name: "Firebase" },
      { name: "React" },
    ...
    imageUrl:
      "https://res.cloudinary.com/dq674z2lp/image/upload/v1680538738/mobile_2_j3yfx3.png",
  ...
  },
  {
    ...
    description:
      "This is an order matching system web application that allows users to place orders, view pending orders, and see completed orders with matched prices with dynamic chart.",
    techStack: [
      { name: "Mongodb" },
      { name: "Express" },
      { name: "React" },
    ...
    imageUrl:
      "https://res.cloudinary.com/dq674z2lp/image/upload/v1682970518/mobile_10_xkgsec.png",
